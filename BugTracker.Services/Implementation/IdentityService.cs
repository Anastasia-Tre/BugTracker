...
namespace BugTracker.Services.Implementation
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<bool> DeleteRoleAsync(string roleId)
        {
            ...
            if (roleDetails.Name == "Administrator")
                throw new BadRequestException(
                    "You can not delete Administrator Role");
        ...
        public async Task<(string id, string roleName)> GetRoleByIdAsync(
            string id)
        {
        ...
        public async Task<bool> AssignUserToRole(string username,
            IList<string> roles)
        {
            var user =
        ...
        public async Task<bool> UpdateUsersRole(string username,
            IList<string> usersRole)
        {
