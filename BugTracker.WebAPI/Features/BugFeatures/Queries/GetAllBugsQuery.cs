...
namespace BugTracker.WebAPI.Features.BugFeatures.Queries
{
    ...
    {
        public class GetAllBugsQueryHandler : IRequestHandler<GetAllBugsQuery, IEnumerable<Bug<int>>>
        {
            ...
            public async Task<IEnumerable<Bug<int>>> Handle(GetAllBugsQuery request, CancellationToken cancellationToken)
            {
